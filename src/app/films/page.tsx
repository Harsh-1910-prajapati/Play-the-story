  ...
  return (
    <div className="pt-28 sm:pt-36 pb-24 bg-[#080808]">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 bg-[#111111] border border-white/10 p-8 sm:p-10">
          <div className="flex items-start gap-4">
            <Video className="w-8 h-8 text-[#c5a880] shrink-0" />
            <div>
              <h3 className="font-serif text-xl text-[#fbf9f5] mb-1">4K Cinema Color</h3>
          ...
          <div className="flex items-start gap-4">
            <Music className="w-8 h-8 text-[#c5a880] shrink-0" />
            <div>
              <h3 className="font-serif text-xl text-[#fbf9f5] mb-1">Live Audio Recording</h3>
              <p className="text-xs text-[#a6a095] font-light leading-relaxed">
          ...
          <div className="flex items-start gap-4">
            <FilmIcon className="w-8 h-8 text-[#c5a880] shrink-0" />
            <div>
              <h3 className="font-serif text-xl text-[#fbf9f5] mb-1">Narrative Pacing</h3>
              <p className="text-xs text-[#a6a095] font-light leading-relaxed">
